...
int main(int argc, char const *argv[])
{
    ...
    while (1)
    {
        ...
        if (pid00 == 0)
        { // PROCESSO FIGLIO CAPO CONNESSIONE
            ...
            while (1)
            {
                ...
                {
                    int pip1[2]; // pipe sort -> grep
                    int pip2[2]; // pipe grep -> socket
                    ...
                    { // Primo figlio (sort)
                        ...
                        char buffy[5000];
                        sprintf(buffy,"%s.txt",str1);

                        if (strcmp(str3, "crescente") == 0)
                        {
                            execlp("sort", "sort", "-n", buffy, NULL);
                            perror("sort");
                            exit(EXIT_FAILURE);
                        }
                        else
