...
public class Main {
    public static void main(String[] args) {
        ...
        try (Socket theSocket = new Socket(args[0], Integer.parseInt(args[1]))) {
            ...
            for (;;) {
                String insUtente;
                System.out.println("Inserire data di interesse, 'fine' per terminare");
                ...
                System.out.println("Inserire tipo di sensore di interesse, 'fine' per terminare");
                insUtente = userIn.readLine();
                networkOut.write(insUtente);
                networkOut.newLine();
                networkOut.flush();
                ...
                System.out.println("Inserire nome stanza di interesse, 'fine' per terminare");
                insUtente = userIn.readLine();
                networkOut.write(insUtente);
                networkOut.newLine();
                networkOut.flush();
